...
router.put('/updateStoreProduct', async (req: Request, res: Response) => {
    const {UPC } = req.body;
    ...
    try {
        const result = await pool.query(
            'UPDATE store_product SET ( "UPC_prom", "id_product", "selling_price", "products_number", "promotional_product" ) = ( $2, $3, $4, $5, $6 ) WHERE "UPC" = $1 RETURNING *',
